...
SPI_IT_State_en SPI_SendDataIT(SPI_Handle_t *pSPIHandle,uint8_t *pTxBuffer, uint32_t Len)
{
	SPI_IT_State_en SPI_State = pSPIHandle->TxState;
...
SPI_IT_State_en SPI_ReceiveDataIT(SPI_Handle_t *pSPIHandle, uint8_t *pRxBuffer, uint32_t Len)
{
	SPI_IT_State_en SPI_State = pSPIHandle->RxState;
